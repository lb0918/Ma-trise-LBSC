...
ns = 4
no = 12
# CM = pyqcm.cluster_model(ns, 8, "clus", [[2, 1, 4, 3, 0, 0, 0, 0, 2, 2, 2, 2], [3, 4, 1, 2, 0, 0, 2, 2, 0, 0, 2, 2]],bath_irrep = True)
# CM = pyqcm.cluster_model(ns, no-ns, "clus", [[4,3,2,1,0,0,0,0,1,1,1,1]],bath_irrep = True)
CM = pyqcm.cluster_model(ns, no-ns, "clus",bath_irrep = True)
