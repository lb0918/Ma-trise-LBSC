...
#-------------------------------------------------------------------
# construction du modèle de réseau 1bande avec terme de saut au 3e voisin
...
model.anomalous_operator("D2",[2,0,0],1,orbitals=(1,1),type="singlet") #NN singlet
model.anomalous_operator("D2",[0,2,0],-1,orbitals=(1,1),type="singlet")