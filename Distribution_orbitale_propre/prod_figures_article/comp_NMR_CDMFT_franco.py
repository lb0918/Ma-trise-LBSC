...
plt.text(0.1,0.55,"$\Delta_n=10$",color="blue")
plt.text(0.2,0.45,"$\Delta_n=6$",color="green")
plt.text(0.31,0.41,"$\Delta_n=5$",color="red")
...
plt.text(0.05, 0.4, 'dopé-e')
plt.text(0.4, 0.9, 'dopé-trous')
